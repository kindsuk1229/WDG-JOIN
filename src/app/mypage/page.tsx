  ...
  useEffect(() => {
    ...
    const fetchMyData = async () => {
      try {
        ...
        // 2. 정산 내역 중 '미정산(pending)' 상태인 금액 가져오기
        ...
        settlementSnap.forEach((doc) => {
          ...
          // ✅ 핵심 수정: (전체 결제 금액) - (나의 1인분 몫) = 실제 받아야 할 돈
          // 예: 10만원 결제, 4명인 경우 -> 100,000 - 25,000 = 75,000원 합산
  ...
  return (
    <div className="min-h-screen bg-white safe-top pb-20">
      <div className="px-5 pt-6">
        ...
        {/* Profile */}
        <div className="flex items-center gap-4 bg-gray-50 rounded-2xl p-5 mb-6 shadow-sm border border-gray-100">
        ...
        <div className="space-y-1">
          {menus.map((item, i) => (
            <div 
              ...
              className="flex items-center gap-3 py-4 border-b border-gray-100 last:border-0 cursor-pointer active:bg-gray-50 px-2 transition-colors"
            >
